...
from custom_textblob.textblob_fr.compat import unicode
...
from custom_textblob.textblob_fr._text import (
...
from custom_textblob.textblob_fr.inflect import (
    pluralize, singularize, NOUN, VERB, ADJECTIVE,
    verbs, conjugate, lemma, lexeme, tenses,
    predicative, attributive
)
# Import all submodules.
from custom_textblob.textblob_fr import inflect
...
replacements.update(((k.upper(), v.upper())
...
class Parser(_Parser):
    ...
    def find_tags(self, tokens, **kwargs):
        ...
        if kwargs.get("tagset") == UNIVERSAL:
            kwargs.setdefault("map", lambda token,
                              tag: penntreebank2universal(token, tag))
...
sentiment = Sentiment(
    ...
    synset=None,
    negations=("n'", "ne", "ni", "non", "pas",
               "rien", "sans", "aucun", "jamais"),
    modifiers=("RB",),
